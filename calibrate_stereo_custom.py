...
camera1_filepath_to_z = {
    os.path.join(absolute_path,"./calibration_images/l1.jpg"): -60,
    os.path.join(absolute_path,"./calibration_images/l2.jpg"): -70,
    os.path.join(absolute_path,"./calibration_images/l3.jpg"): -80,
    os.path.join(absolute_path,"./calibration_images/l4.jpg"): -90,
    os.path.join(absolute_path,"./calibration_images/l5.jpg"): -100,
    os.path.join(absolute_path,"./calibration_images/l6.jpg"): -110,
    os.path.join(absolute_path,"./calibration_images/l7.jpg"): -120
}

camera2_filepath_to_z = {
    os.path.join(absolute_path,"./calibration_images/r1.jpg"): -60,
    os.path.join(absolute_path,"./calibration_images/r2.jpg"): -70,
    os.path.join(absolute_path,"./calibration_images/r3.jpg"): -80,
    os.path.join(absolute_path,"./calibration_images/r4.jpg"): -90,
    os.path.join(absolute_path,"./calibration_images/r5.jpg"): -100,
    os.path.join(absolute_path,"./calibration_images/r6.jpg"): -110,
    os.path.join(absolute_path,"./calibration_images/r7.jpg"): -120
}
