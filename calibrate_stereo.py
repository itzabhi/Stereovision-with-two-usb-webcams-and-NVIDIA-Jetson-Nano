...
camera1_filepath_to_z = {
    os.path.join(absolute_path,"./calibration_images/camera_1_60cm.png"): -60,
    os.path.join(absolute_path,"./calibration_images/camera_1_70cm.png"): -70,
    os.path.join(absolute_path,"./calibration_images/camera_1_80cm.png"): -80,
    os.path.join(absolute_path,"./calibration_images/camera_1_90cm.png"): -90,
    os.path.join(absolute_path,"./calibration_images/camera_1_100cm.png"): -100,
    os.path.join(absolute_path,"./calibration_images/camera_1_110cm.png"): -110,
    os.path.join(absolute_path,"./calibration_images/camera_1_120cm.png"): -120
}

camera2_filepath_to_z = {
    os.path.join(absolute_path,"./calibration_images/camera_2_60cm.png"): -60,
    os.path.join(absolute_path,"./calibration_images/camera_2_70cm.png"): -70,
    os.path.join(absolute_path,"./calibration_images/camera_2_80cm.png"): -80,
    os.path.join(absolute_path,"./calibration_images/camera_2_90cm.png"): -90,
    os.path.join(absolute_path,"./calibration_images/camera_2_100cm.png"): -100,
    os.path.join(absolute_path,"./calibration_images/camera_2_110cm.png"): -110,
    os.path.join(absolute_path,"./calibration_images/camera_2_120cm.png"): -120
}

camera1_radial_distortion_filepath = os.path.join(absolute_path,"./radial_distortion/calibration_left.pkl")
camera2_radial_distortion_filepath = os.path.join(absolute_path,"./radial_distortion/calibration_right.pkl")
grid_shapeHW = (6, 6)
calibration_pattern_xy_filepath = os.path.join(absolute_path,"./calibration_images/calibration_pattern_xy.csv")

output_directory = os.path.join(absolute_path,"./output_calibrate_stereo")
