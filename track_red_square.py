...
def TimestampToImageFilepathsList(camera_ID_list, images_filepath_prefix):
    ...
    first_camera_image_filepaths = [filepath for filepath in image_filepaths if filepath.startswith(first_camera_prefix)]#\
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inputImagesFilepathPrefix', help="The filepath prefix of the input images. Default: 'red_square_images/camera_'",
                        default=os.path.join(absolute_path,'./red_square_images\\camera_'))
    parser.add_argument('--outputDirectory', help="The output directory. Defaut: './output_track_red_square'",
                        default=os.path.join(absolute_path,'./output_track_red_square'))
    ...
    parser.add_argument('--projectionMatrix1Filepath',
                        ...
                        default=os.path.join(absolute_path,"./output_calibrate_stereo/camera1.projmtx"))
    parser.add_argument('--projectionMatrix2Filepath',
                        ...
                        default=os.path.join(absolute_path,"./output_calibrate_stereo/camera2.projmtx"))
    parser.add_argument('--radialDistortion1Filepath',
                        ...
                        default=os.path.join(absolute_path,'./radial_distortion/calibration_left.pkl'))
    parser.add_argument('--radialDistortion2Filepath',
                        ...
                        default=os.path.join(absolute_path,'./radial_distortion/calibration_right.pkl'))
